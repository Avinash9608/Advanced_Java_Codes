 ...
 * @author avina
 */
public class MyBatchUpdateApp1 {
    public static void main(String [] args)
    {
        ...
        try
        {
            ...
            st.addBatch("Delete from emp where dptno=30");
            st.addBatch("Insert into students values(102,'Deepesh','15-AUG-1947')");
            st.addBatch("Update allbooks set bookprice=bookprice+200 where subject='JEE'");
